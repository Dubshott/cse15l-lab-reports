...
Once you have downloaded Git Bash, you need to open the terminal on VSCode. To do this, use the following command: Ctrl + `. If you do that, you should see this: <img width="770" alt="image" src="https://user-images.githubusercontent.com/55414361/211927352-2badbeca-7ab6-4d63-b60b-fd9897567d01.png">

Once we pulled up the terminal, we need to do the following steps to change the normal VSCode scripting to bash scripting:
1. Use the command Ctrl + Shift + P.  This should create a drop down menu. <img width="766" alt="image" src="https://user-images.githubusercontent.com/55414361/211927693-5a0bbcfd-ff3c-4091-8303-95c673a00427.png">
2. In that search bar type in 'Select Default Profile' and click it. 
3. Select 'Git Bash' <img width="448" alt="image" src="https://user-images.githubusercontent.com/55414361/211928089-2d5604d3-84ef-4c6f-bee3-2f9df95df772.png">
4. Now down in the terminal there is a plus button. Press that. <img width="733" alt="image" src="https://user-images.githubusercontent.com/55414361/211928246-ad4b3f28-2ce5-4e58-818c-85ba3b4f3606.png">
